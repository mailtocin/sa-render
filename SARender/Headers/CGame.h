...
#define CWeather__CloudCoverage (*(float *)0xC81304)
...
#define RwD3D9D3D9ViewTransform ((D3DXMATRIX*) 0xC9BC80)
#define RwD3D9D3D9ProjTransform ((D3DXMATRIX*) 0x8E2458)
...
#define D3D9ViewProjTransform ((D3DXMATRIX*)0xC94C30)
#define RwD3D9ActiveViewProjTransform ((D3DXMATRIX)0xC97C64)
#define D3D9ActiveTransform ((D3DXMATRIX*)0xC94C70)
...
#define WindowHandle ((HWND)0xC97C1C)
#define dword_C9BEE4 (*(DWORD*)0xC9BEE4)
#define dword_C9BEE8 (*(DWORD*)0xC9BEE8)
#define unk_C97C34 (*(DWORD*)0xC97C34)
...
#define m_snTimeInMilliseconds ((float)0xB7CB84)
#define ms_fTimeStep ((float)0xB7CB5C)
#define m_UserPause (*(int*)0xB7CB49)
#define InsideScene (*(int*)0xC97C54)
#define currArea (*(int*)0xB72914)
#define CCutsceneMgr__ms_loaded ((UINT)0xB5F84C)
#define nDrawCallCount (*(int*)0xB73708)
#define skinMatricles ((float*)0xC978AC)
...
#define _rpD3D9SkinVertexShaderMatrixUpdate(matrix, atomic, skin) ((RpAtomic * (__cdecl *)(RwMatrixTag **, RpAtomic *, RpSkin*)) 0x7C78A0)(matrix, atomic, skin)
...
#define RpWorldCreate(bbox) ((RpWorld* (__cdecl*) (RwBBox *)) 0x74F760)(bbox)

#define RwD3D9TextureHasAlpha(texture) ((int (__cdecl*) (int)) 0x4C9EA0)(texture)
#define MainWndProc(hWnd, message, wParam, lParam) ((int (__stdcall*)(HWND, int, WPARAM, int)) 0x747EB0)(hWnd, message, wParam, lParam)
...
#define RwReadTexture(name,maskname) ((RwTexture* (__cdecl *)(char*,char*))0x7F3AC0)(name,maskname)
...
#define RenderReallyDrawLastObjects() ((void (__cdecl *)())0x733800)()
...
#define RwD3D9SetTransform(state, matrix) ((bool (__cdecl*) (int , RwMatrixTag *))0x7FA390)(state, matrix)
...
void DrawPostProcessPass(CEffect *);
